...
function peg$parse(input, options) {
  ...
  var peg$startRuleFunctions = { tiles: peg$parsetiles };
  var peg$startRuleFunction = peg$parsetiles;
  ...
  var peg$e1 = peg$literalExpectation("Tile", false);
  ...
  var peg$f0 = function(c) { return c.map(s => (s === '#') ? 1 : 0 ) };
  var peg$f1 = function(n) { return parseInt(n) };
